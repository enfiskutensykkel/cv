...
\parbox[t][][t]{\linewidth}{
	...
	\bigskip
	Collaborated with, at first, and then later working for Dolphin Interconnect Solutions.
	Developing a framework for distributed composable architecture and high-performance I/O in a PCIe cluster.
	Gained experience with PCIe, NTBs, high-speed interconnects, RDMA, distributed shared-memory
	architectures, NVMe, GPU programming, and kernel hacking.
...
%			involving CPU in the data path.}\\[-.6em]
		...
		\item{Developed various GPUDirect RDMA performance benchmarking tools.}
	\end{itemize}
	\bigskip
	\bigskip
}
...
\parbox[t][][t]{\linewidth}{
	...
	caches, as well as designing REST services and creating HTTP endpoints with C++ (FastCGI)
