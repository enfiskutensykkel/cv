...
\parbox[t][][t]{\linewidth}{
	...
	Currently developing a framework for distributed composable architecture and high-performance I/O in a PCIe cluster.
	Gained experience with PCIe, NTBs, high-speed interconnects, RDMA, distributed shared-memory
	architectures, NVMe, GPU programming, Nvidia GPUDirect, driver development and kernel hacking.
