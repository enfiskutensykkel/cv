...
\setlist[itemize]{leftmargin=*,rightmargin=0pt,itemsep=2pt,topsep=1em}
...
% Set size of columns
\newcommand{\hmargin}{1.8cm} % 1.8cm or more is ideal
\newcommand{\lcolwidth}{.60\textwidth}
\newcommand{\rcolwidth}{.35\textwidth}
\newcommand{\lcolheight}{.9\textheight}
\newcommand{\rcolheight}{.9\textheight}
...
\newenvironment{experience}[3][]{%
    ...
    \end{itemize}
	\ifthenelse{\equal{\last}{true}}{}{\bigskip\bigskip\smallskip}%
}
...
\newcommand{\shortexperience}[3][]{%
	...
	\parbox{\linewidth}{\noindent\ignorespaces {#2}}%
	\ifthenelse{\equal{#1}{}}{\bigskip\bigskip\smallskip}{}%
}
...
\begin{document}
\pagestyle{empty}
\begin{minipage}[t][\hmargin][c]{\lcolwidth}
	{\huge\textbf{Jonas Markussen}}\\[1.1em]
    {\Large{R\&D Systems Software Engineer}}
\end{minipage}%
\hfill%
\protect\begin{minipage}[t][\hmargin][c]{\rcolwidth}
...
\begin{minipage}[t][\lcolheight][t]{\lcolwidth}
	\input{exp}
\end{minipage}%
\hfill%
\begin{minipage}[t][\rcolheight][t]{\rcolwidth}
	\input{edu}
    \vfill
	\input{skills}
    \vfill
